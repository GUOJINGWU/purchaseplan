...
public class AuthInfo {
    ...
    private List<AuthSubsidiary> subsidiarieList;// 用户所属所有子公司
    private AuthSubs subs;// 当前用户子公司信息

    public AuthSubs getSubs() {
        return subs;
    }

    public void setSubs(AuthSubs subs) {
        this.subs = subs;
    }

    public List<AuthSubsidiary> getSubsidiarieList() {
        return subsidiarieList;
    }

    public void setSubsidiarieList(List<AuthSubsidiary> subsidiarieList) {
        this.subsidiarieList = subsidiarieList;
    }
