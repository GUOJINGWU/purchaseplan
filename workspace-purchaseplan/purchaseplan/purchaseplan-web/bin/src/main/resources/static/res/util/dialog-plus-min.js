!(function() {
	...
	define("dialog-config", {
		...
		innerHTML: '<div i="dialog" class="ui-dialog">' + '<div class="ui-dialog-arrow-a"></div>' + '<div class="ui-dialog-arrow-b"></div>' + '<table class="ui-dialog-grid">' + '<tr>' + '<td i="header" class="ui-dialog-header"><button i="close" class="ui-dialog-close"></button><div i="title" class="ui-dialog-title"></div>' + '</td>' + '</tr>' + '<tr>' + '<td i="body" class="ui-dialog-body"><div i="content" class="ui-dialog-content"></div>' + '</td>' + '</tr>' + '<tr>' + '<td i="footer" class="ui-dialog-footer">' + '<div i="button" class="ui-dialog-button"></div>' + '<div i="statusbar" class="ui-dialog-statusbar"></div>' + '</td>' + '</tr>' + '</table>' + '</div>'
	});
	define("dialog", function(require) {
		...
		artDialog.create = function(options) {
			...
			this._$('close').css('display', this.cancel === false ? 'none' : '').attr('title', this.cancelValue).on('click', function(event) {
			    ...
			    top.$("#" + options.id).remove();
			    //top.document.getElementById(options.id).remove();
			    event.preventDefault();
			});
			this._$('dialog').addClass(this.skin);
			this._$('body').css('padding', this.padding);
			this._$('body').find("i").addClass(this.Icon);
			if (options.quickClose) {
